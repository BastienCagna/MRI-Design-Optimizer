...
datasets = [
   {
      ...
      "motion_file": "/hpc/banco/InterTVA/virginia/analyse_pilot/S00"
                     "/Functional/Localizer/new/rp_task-localizer_bold.txt",
      "tr": 0.975
   },
   {
      "subject_name": "sub-01",
      ...
      "motion_file": "/hpc/banco/InterTVA/virginia/analyse_pilot/sub-01/func"
                     "/session1/rp_sub-01_task-localizer-best_bold.txt",
      "tr": 0.955
   },
   {
      "subject_name": "sub-02",
      ...
      "motion_file": "/hpc/banco/InterTVA/virginia/analyse_pilot/sub-02/func/"
                     "rp_sub-02_task-localizer-best_bold.txt",
      "tr": 0.955
   },
]
...
for i, dataset in enumerate(datasets):
    ...
    glm(subject_dir, dataset['subject_name'], dataset['run_name'] +
        ...
        contrasts_list_file=con_file, tr=dataset['tr'], motion_file=dataset[
            "motion_file"])
